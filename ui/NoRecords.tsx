...
export default function NoRecords({
  ...
  return (
    <div className="flex flex-col flex-1 items-center justify-center p-8  w-full text-center bg-red-500 rounded-2xl border border-slate-100 shadow-[0_2px_8px_-3px_rgba(0,0,0,0.02)]">
      {/* Icon Area */}
