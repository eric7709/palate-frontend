    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="relative group">
        <input
          ...
          disabled={disabled}
          {...registration}
          className={`w-full px-3 py-1.5 rounded-lg bg-[#1c1f26] border text-xs text-white placeholder-gray-500
    ...
    <div className="flex flex-col gap-1">
      ...
      <div ref={ref} className="relative">
        <button
          ...
          disabled={disabled}
          onClick={() => setOpen((o) => !o)}
          className={`w-full flex items-center justify-between px-3 py-1.5 rounded-lg bg-[#1c1f26] border text-xs
        ...
        {open && (
          <div className="absolute z-50 mt-1 w-full rounded-lg bg-[#252932] backdrop-blur-sm border border-gray-700 shadow-2xl shadow-black/40 overflow-hidden animate-in fade-in zoom-in-95 duration-100">
